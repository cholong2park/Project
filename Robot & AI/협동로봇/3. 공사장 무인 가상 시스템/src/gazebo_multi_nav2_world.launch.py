...
def generate_launch_description():
    ...
    TURTLEBOT3_MODEL0 = 'waffle'
    TURTLEBOT3_MODEL1 = 'waffle_pi'
    ...
    urdf0 = os.path.join(
        turtlebot3_multi_robot, 'urdf', 'turtlebot3_' + TURTLEBOT3_MODEL0 + '.urdf'
    )
    urdf1 = os.path.join(
        turtlebot3_multi_robot, 'urdf', 'turtlebot3_' + 'manipulation' + '.urdf' + '.xacro'
    )

    world = os.path.join(
        get_package_share_directory('turtlebot3_multi_robot'),
        'worlds', "Construction_world.sdf")
    ...
    for robot in robots:
        if robot['name']=='waffle_pi':
            urdf=urdf1
            TURTLEBOT3_MODEL=TURTLEBOT3_MODEL1
        else:
            urdf=urdf0
            TURTLEBOT3_MODEL=TURTLEBOT3_MODEL0
